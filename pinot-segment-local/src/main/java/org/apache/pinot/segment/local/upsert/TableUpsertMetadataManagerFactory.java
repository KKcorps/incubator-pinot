...
public class TableUpsertMetadataManagerFactory {
  ...
  public static TableUpsertMetadataManager create(TableConfig tableConfig, Schema schema,
      TableDataManager tableDataManager, ServerMetrics serverMetrics, HelixManager helixManager, ZkHelixPropertyStore<ZNRecord> propertyStore) {
    ...
    metadataManager.init(tableConfig, schema, tableDataManager, serverMetrics, helixManager, propertyStore);
