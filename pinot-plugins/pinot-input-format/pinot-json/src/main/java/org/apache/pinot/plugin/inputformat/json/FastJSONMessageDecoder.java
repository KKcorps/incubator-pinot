 ...
 */
public class FastJSONMessageDecoder implements StreamMessageDecoder<byte[]> {
  private static final Logger LOGGER = LoggerFactory.getLogger(FastJSONMessageDecoder.class);
  ...
  public GenericRow decode(byte[] payload, GenericRow destination) {
    try {
      Map<String, Object> from = JSON.parseObject(payload, Map.class);
