...
//   */
//  public HNSWVectorIndexReader(String column, File indexDir, int numDocs,
...
//  }
  ...
  @Override
  public MutableRoaringBitmap getDocIds(Vector searchQuery) {
    ...
    try {
      ...
      KnnFloatVectorQuery knnFloatVectorQuery = new KnnFloatVectorQuery(_column, searchQuery.getFloatValues(), 1);
